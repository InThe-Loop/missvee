<!-- privacy modal -->
<div class="modal modal-fullscreen fade" id="termsModal" tabindex="-1" role="dialog" aria-labelledby="termsModal" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-dark" id="myModalLabel">Our terms and conditions</h4>
            ...
            <div class="modal-body text-dark">
                ...
                <li>
                <p><strong>"Company"</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to <strong>MissVee</strong></p>
                </li>
                <li>
                ...
                <li>
                <p><strong>"Products"</strong> refers to the products or items offered for sale on the Service.</p>
                </li>
                <li>
                <p><strong>"Orders"</strong> means a request by You to purchase Products from Us.</p>
                </li>
                <li>
                <p><strong>"Promotions"</strong> refers to contests, sweepstakes or other promotions offered through the Service.</p>
                </li>
                <li>
                ...
                <li>
                <p><strong>"Website"</strong> refers to <strong>MissVee</strong>, accessible from <strong>missveefamouslook.store</strong></p>
                </li>
                <li>
                ...
                <p><strong>Placing Orders for Products</strong></p>
                ...
                <p>If you purchase a Product, and for some reason you decide that you would like a refund, you have 7 days to request a refund. If you request a refund within 7 days from the date of purchase, <strong>MissVee</strong> will give you 70% refund of your purchase price (provided the item is still in its original form).</p>
                <p>If you do not request a refund within the 7 day refund period, you forfeit this option and will not be eligible for a refund.</p>
                ...
                <p>Payment can be made through various payment methods as supported by Yoco.</p>
                <p>Payment cards (credit cards or debit cards) are subject to validation checks and authorisation by Your card issuer. If we do not receive the required authorisation, We will not be liable for any delay or non-delivery of Your Order.</p>
                ...
                <p>You may not use as a username the name of another person or entity or that is not lawfully available for use, a name or trademark that is subject to any rights of another person or entity other than You without appropriate authorisation, or a name that is otherwise offensive, vulgar or obscene.</p>
                ...
                <p>If You are a copyright owner, or authorised on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email (<a href="mailto:help@missveefamouslook.store">help@missveefamouslook.store</a>) and include in Your notice a detailed description of the alleged infringement.</p>
                ...
                <p>The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the Service. Your use of the Application may also be subject to other local, national, or international laws.</p>
                ...
                <ul>
                    <li>By visiting this page on our website: <a href="{{ route('contact') }}">Contact us page</a></li>
                    <li>By sending us an email: <a href="mailto:enquiries@missveefamouslook.store">Help and support</a></li>
                </ul>
            </div>
